  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="max-w-6xl mx-auto px-4 lg:px-8 py-16">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
            <div className="bg-card border-2 border-border rounded-3xl p-8 md:p-10 shadow-lg">
              <h2 className="text-2xl font-bold text-foreground mb-6 flex items-center gap-2">
                <Send className="w-6 h-6 text-accent" /> Üzenet küldése
              </h2>
              <form onSubmit={handleSubmit} className="flex flex-col gap-6" noValidate>
                {[
                  ...
                  <div key={f.name} className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      className={`px-4 py-3 rounded-2xl border-2 text-base bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent ${
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className={`px-4 py-3 rounded-2xl border-2 text-base bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent resize-y ${
                ...
                <button
                  type="submit"
                  className="px-8 py-4 rounded-2xl bg-accent text-accent-foreground text-base font-bold hover:opacity-90 transition-opacity"
                >
                  Elküldés
                </button>
              </form>
            ...
            <div className="space-y-6">
              <div className="bg-card border-2 border-border rounded-3xl p-8 shadow-sm flex gap-5 items-start">
                <span className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-accent/15 text-accent shrink-0">
                  <Mail className="w-7 h-7" aria-hidden="true" />
                </span>
                <div>
                  <h3 className="font-bold text-foreground text-lg mb-2">E-mail</h3>
                  <a href="mailto:info@jegyalert.com" className="text-accent font-semibold hover:underline text-lg">
                    info@jegyalert.com
                  </a>
                </div>
              </div>
              <div className="bg-card border-2 border-border rounded-3xl p-8 shadow-sm flex gap-5 items-start">
                ...
                <div>
                  <h3 className="font-bold text-foreground text-lg mb-2">Válaszidő</h3>
                  <p className="text-muted-foreground leading-relaxed">
                    Általában 1–2 munkanapon belül válaszolunk minden megkeresésre.
                  </p>
                </div>
              </div>
              <div className="bg-card border-2 border-border rounded-3xl p-8 shadow-sm flex gap-5 items-start">
      ...
      {submitted && (
        ...
        >
          <div
            className="bg-card border-2 border-border rounded-3xl shadow-2xl p-10 max-w-md w-full text-center"
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              Köszönjük! Válaszunkat az <strong className="text-foreground">info@jegyalert.com</strong> címen küldjük, általában 1–2 munkanapon belül.
            </p>
            <button
              onClick={() => setSubmitted(false)}
              className="px-8 py-3 rounded-2xl bg-accent text-accent-foreground font-semibold hover:opacity-90 transition-opacity"
            >
              Bezárás
            </button>
          </div>
